...
"""
@author: WanZhiWen 
@file: ConvolutionModel.py 
@time: 2018-01-06 22:02

使用卷积神经网络来构造一个图片分类器，对输入的手势图片进行多分类，
手势表示的数字为(0,1,2,3,4,5)之一，使用TensorFlow来构建模型
"""
import time
import os
...
parameters = model(X_train, Y_train, X_test, Y_test, learning_rate=0.004)
end_time = time.time()
